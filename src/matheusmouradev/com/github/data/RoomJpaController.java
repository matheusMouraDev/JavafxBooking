...
import matheusmouradev.com.github.data.exceptions.NonexistentEntityException;
import matheusmouradev.com.github.data.exceptions.PreexistingEntityException;
...
public class RoomJpaController implements Serializable {
    ...
    public void create(Room room) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findRoom(room.getNumber()) != null) {
